...
syn match cssBoxProp contained "\-moz-box-shadow\>"
syn match cssBoxProp contained "\-webkit-box-shadow\>"
...
syn match cssBoxProp contained "-webkit-border-radius\>"
syn match cssBoxProp contained "-webkit-border-radius\(-\(bottomleft\|bottomright\|topright\|topleft\)\)\>"
